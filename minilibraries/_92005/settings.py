"""
Django settings for minilibraries project.
...
ADMINS = [("Logan Bentley", "logangbentley@gmail.com")]
...
with open("keys/secret.txt") as f:
...
WSGI_APPLICATION = '_92005.wsgi.application'
